                    ...
                    <div className="mt-12">
                        <form>
                            <div>
                                ...
                                <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-blue-600" type="" placeholder="mike@gmail.com" />
                            </div>
                            <div className="mt-8">
                            ...
                            <div className="mt-10">
                                <button className="bg-background text-gray-100 p-4 w-full rounded-full tracking-wide
