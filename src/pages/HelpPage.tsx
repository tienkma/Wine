        ...
        <div className="container mx-auto flex max-lg:flex-col lg:divide-x pt-4 py-14">
          <div className="lg:pr-8 flex-1">
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  Please contact us at Contact page within 24 hours to confirm
                  the correct one. The deadline to change the address is 48
                  hours from the placing of your order. For any other
                  information, please visit the Shipping Policy Page.
                </Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  widely used on the Internet for processing payments. Your
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  charging additional fees, while other banks do not. Sadly,
                  ...
                  ask if this is intentional, which it is. The payment will
                  remain secure as Stripe is PCI-compliant and handles the whole
                  payment process for us.
                </Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion
            ...
            >
              ...
              >
                <Typography>
                  ...
                  sender. Can you reship my order to the correct address and
                  I'll just pay the shipping fee?
                </Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography>
                  ...
                  sender (in this case, we just can support contacting the
          ...
          <div className="lg:pl-8 max-lg:mt-8 flex-1">
            ...
            >
              ...
              >
                <Typography>
                  I ordered a wrong product. Can I return it and exchange it
                  with the product that I want?
                </Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography>
                  Since our products are custom-made and we only produce a
                  product once we receive an order, we don&rsquo;t accept
                  returns and exchange it for another product especially if it
                  is due to the customer&rsquo;s mistake. It is very important
                  to review your order carefully before check-out.
                  <p className="my-3"></p>
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  Please contact our Customer Support team by sending an email
                  via Contact Us page to start the complaint process. Please
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  before a refund is posted. If you&rsquo;ve done all of this
                  and you still have not received your refund yet, please
                  contact us at{" "}
                  <Link
                ...
                <Typography>
                  <ul className="ml-4">
                    <li className="list-disc mb-2">
                      Your order is only eligible to be cancelled within 12
                      hours of placing the order. After that time, the order is
                      locked for processing and can no longer be cancelled.{" "}
                    </li>
                    <li className="list-disc mb-2">
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  Please email us at Contact page with a photo of the product
                  you received along with detailed shots you wish to include. We
                  will use this information to look into a replacement and
                  prevent future errors. Our customer service team will review
                  your claim. If your claim is approved, we will provide you
