        ...
        <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                ...
                <nav className="mb-10 list-none">
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white transition-colors">Company</a>
                    </li>
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white transition-colors">Careers</a>
                    </li>
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white transition-colors">Blog</a>
                    </li>
                </nav>
            </div>
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                ...
                <nav className="mb-10 list-none">
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white transition-colors">Contact Support</a>
                    </li>
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white transition-colors">Help Resources</a>
                    </li>
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white transition-colors">Release Updates</a>
                    </li>
                </nav>
            </div>
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                ...
                <nav className="mb-10 list-none">
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white transition-colors">Terms &amp; Privacy</a>
                    </li>
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white transition-colors">Pricing</a>
                    </li>
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white transition-colors">FAQ</a>
                    </li>
                </nav>
            </div>
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                ...
                <nav className="mb-10 list-none">
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white transition-colors">Send a Message</a>
                    </li>
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white transition-colors">Request a Quote</a>
                    </li>
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white transition-colors">+123-456-7890</a>
                    </li>
                </nav>
            </div>
        </div>
